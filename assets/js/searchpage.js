...
let imageContent = ["Musica","Podcast","Eventi dal vivo","Create per te","Nuove uscite","Il 2023 musica","Il 2023 in Podcast","Merch","Estate",
"Pop","Buone feste","Hip Pop","Classifiche podcast","Nuove uscite nei podcast","Video podcast","Solo su Spotify","Classifiche","Dance/Elettronica",
"Latina","Rock","Indie","Scopri","Mood","Sanremo","In auto","Di tendenza","EQUAL","RADAR","Allenamento","Party"];
...
function getImages(imageContent){
    ...
    singleCard.setAttribute("style",`background-color:rgb(${randomNumber1},${randomNumber2},${randomNumber3})`);
    });
}
  ...
  function searchKeyword(string){
    ...
    function populateSearchPage(songs){
      ...
      for (let i = 1 ; i < 5 ; i++) {
        ...
        let songCard = `<li class="row pt-2 my-2 popular align-items-center position-relative">
                ...
                <p class="col-1 position-absolute end-0">${time}</p>
            </li>`
